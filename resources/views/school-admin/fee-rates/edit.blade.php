<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Fee Rate</h2>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
            ...
            <div class="flex items-center gap-2">
                ...
                <span class="text-gray-500 text-sm">Edit Fee Rate</span>
            </div>
            ...
            <div class="bg-white shadow rounded-md overflow-hidden border-t-4 border-indigo-600">
                <div class="px-6 py-5 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-500 mt-1">Update the details below and save your changes.</p>
                </div>

                <form action="{{ route('school-admin.fee-rates.update', $feeRate) }}" method="POST" class="px-6 py-6 max-w-2xl">
                    @csrf
                    @method('PUT')
