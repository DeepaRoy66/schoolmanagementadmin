<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">New Emergency Contact</h2>
    </x-slot>
    ...
    <div class="p-6">
        ...
        <div class="bg-white rounded-lg border border-slate-200 shadow-sm p-6 max-w-xl">
            <form action="{{ route('school-admin.emergency-contacts.store') }}" method="POST">
                @csrf
