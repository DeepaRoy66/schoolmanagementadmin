    ...
    <div class="py-8">
        <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
            ...
            <div class="flex items-center gap-2">
                ...
                <span class="text-gray-500 text-sm">Add Fee Name</span>
            </div>
                ...
                <form method="POST" action="{{ route('school-admin.fee-names.store') }}">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name') }}"
                                   ...
                                   placeholder="e.g. Monthly Tuition" required>
                            @error('name')
                                <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 flex items-center gap-2">
                        <input type="checkbox" name="discount_applicable" id="discount_applicable" value="1"
                               {{ old('discount_applicable', true) ? 'checked' : '' }}
                               class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
