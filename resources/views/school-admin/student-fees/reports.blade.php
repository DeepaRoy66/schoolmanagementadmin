<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4">Category-wise Breakdown</h3>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @forelse($categoryBreakdown as $categoryName => $data)
                                <tr class="text-sm text-gray-700">
                                    <td class="px-4 py-3">{{ $categoryName }}</td>
                                    <td class="px-4 py-3">{{ number_format($data['total_amount'], 2) }}</td>
                                    <td class="px-4 py-3">{{ number_format($data['total_paid'], 2) }}</td>
                                </tr>
                            @empty
                                <tr>
