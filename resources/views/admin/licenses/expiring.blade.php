            ...
            <div class="bg-white shadow-sm rounded-md border border-gray-100 overflow-hidden">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 px-6 py-5 border-b border-gray-100">
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 rounded-md bg-amber-50 flex items-center justify-center shrink-0">
                    ...
                    <div class="flex items-center gap-2">
                        @foreach ([7, 14, 30, 60] as $window)
                            <a href="{{ route('admin.licenses.expiring', ['days' => $window]) }}"
                               class="inline-flex items-center px-3 py-1.5 rounded-md text-xs font-medium border transition
                                      {{ (int) $days === $window
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @forelse ($schools as $school)
                                ...
                                <tr class="hover:bg-gray-50/60 transition">
                                    <td class="py-4 px-6">
                                        <div class="flex items-center gap-3">
                                            <div class="w-8 h-8 rounded-md bg-indigo-50 text-indigo-600 flex items-center justify-center text-xs font-semibold shrink-0">
