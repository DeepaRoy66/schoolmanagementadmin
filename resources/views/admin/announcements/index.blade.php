                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 px-6 py-5 border-b border-gray-100">
                    ...
                    @if ($isSuperAdmin)
                        <a href="{{ route('admin.announcements.create') }}"
                           class="inline-flex items-center justify-center gap-1.5 bg-indigo-600 text-white px-4 py-2.5 rounded-md text-sm font-medium hover:bg-indigo-700 active:scale-[0.98] transition">
                        ...
                        <div class="p-6 flex gap-4">
                            @if ($announcement->image)
                                <img src="{{ $announcement->image_url }}"
                                     ...
                                     class="w-20 h-20 rounded-md object-cover border border-gray-100 shrink-0">
                            @else
                                <div class="w-20 h-20 rounded-md bg-gray-50 flex items-center justify-center shrink-0">
                                        ...
                                        <form action="{{ route('admin.announcements.destroy', $announcement) }}" method="POST"
                                            ...
                                            <button type="submit"
                                                    class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-semibold
                                                           ...
                                                           hover:bg-rose-600 transition shadow-sm shrink-0"
                                                    title="Delete">
